...
OSPFDaemon::Ptr
OSPFDaemon::New(OSPFRouter::Ptr ospf_router, ControlPlane::Ptr cp) {
  return new OSPFDaemon(ospf_router, cp);
}

OSPFDaemon::OSPFDaemon(OSPFRouter::Ptr ospf_router, ControlPlane::Ptr cp)
